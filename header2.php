...
<div id = "actual_header" class = "header" style="height:75px; display: none!important; position: fixed; top: 0;">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        setTimeout(function () {
            ...
            document.getElementById('actual_header').setAttribute('style', 'height:75px; display: block !important; position: fixed; top: 0;');
